...
export default function MyCollectionPage({ sets, stats, onTogglePiece, onTogglePieceWishlist, onUpdatePieceNotas }) {
    ...
    <div style={{ display:'flex',flexDirection:'column',height:'100%',overflow:'hidden' }}>
      ...
      {selectedSet && (
        <ArmorSetModal
          ...
          onTogglePiece={onTogglePiece} onTogglePieceWishlist={onTogglePieceWishlist} onUpdatePieceNotas={onUpdatePieceNotas}
        />
      )}
    </div>
  );
