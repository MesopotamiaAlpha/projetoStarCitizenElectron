...
const ORE_DATABASE = {
  ...
  'Minério de Nave': {
    ...
    ores: [
      ...
      { name:'Inert Material',rarity:'common', notes:'Subproduto comum' },
  ...
  'FPS / ROC Mining': {
    ...
    icon: '🔧',
    ores: [
      { name:'Aphorite',    rarity:'rare',     notes:'Gema, não precisa refinar, alto valor' },
      { name:'Dolivine',    rarity:'rare',     notes:'Gema, não precisa refinar' },
      { name:'Hadanite',    rarity:'epic',     notes:'Gema mais valiosa, FPS mining' },
      { name:'Caranite',    rarity:'uncommon', notes:'Luas de Hurston, ROC' },
      { name:'Orotite',     rarity:'uncommon', notes:'ROC mining, bom valor' },
      { name:'Titanium',    rarity:'uncommon', notes:'ROC e FPS' },
      { name:'Copper',      rarity:'common',   notes:'ROC e FPS' },
      { name:'Agricium',    rarity:'uncommon', notes:'ROC mining' },
      { name:'Tungsten',    rarity:'uncommon', notes:'ROC, Hurston' },
    ],
  },
  // PLANTAS / FLORES
  'Plantas e Flores': {
    ...
    icon: '🌿',
    ores: [
      { name:'Widow',       rarity:'uncommon', notes:'Planta colhível, contrabando' },
      { name:'WiDoW',       rarity:'rare',     notes:'Versão refinada de Widow' },
      { name:'Maze',        rarity:'uncommon', notes:'Planta colhível' },
      { name:'Slam',        rarity:'rare',     notes:'Planta colhível, contrabando' },
      { name:'Neon',        rarity:'uncommon', notes:'Planta colhível' },
      { name:'Altruciatoxin',rarity:'rare',    notes:'Substância de planta' },
      { name:'GreenGro',    rarity:'common',   notes:'Planta colhível' },
    ],
  },
  // MATERIAIS CRAFTADOS / REFINADOS
  'Materiais Refinados': {
    color: '#a29bfe',
    icon: '⚗️',
    ores: [
      { name:'Steel',                rarity:'common',   notes:'Refinado de Iron' },
      { name:'Polymer',              rarity:'common',   notes:'Refinado de Inert Material' },
      { name:'Industrial Polymer',   rarity:'uncommon', notes:'Refinado avançado' },
      { name:'Medical Grade Polymer',rarity:'rare',     notes:'Uso em craft médico' },
      { name:'Reactive Material',    rarity:'rare',     notes:'Bunker loot / craft' },
      { name:'Carbon Fiber',         rarity:'uncommon', notes:'Material composto' },
      { name:'Stims',                rarity:'common',   notes:'Consumível médico' },
      { name:'Pitambu',              rarity:'uncommon', notes:'Recurso especial' },
      { name:'Mg Script',            rarity:'rare',     notes:'50 = 1 Wikelo Favor' },
      { name:'Concuil Script',       rarity:'rare',     notes:'50 = 1 Wikelo Favor' },
    ],
  },
};
...
const RARITY_COLORS = {
  common:'#7a90b0', uncommon:'#00d4ff', rare:'#ffc436', epic:'#a29bfe', legendary:'#ff4466'
};

const ORE_COLORS = {
  'Titanium':'#74b9ff','Copper':'#fdcb6e','Orotite':'#a29bfe','Caranite':'#fd79a8',
  'Steel':'#b2bec3','Laranite':'#fd79a8','Taranite':'#74b9ff','Bexalite':'#a29bfe',
  'Quantainium':'#00e5a0','Gold':'#ffc436','Diamond':'#dfe6e9','Tungsten':'#dfe6e9',
  ...
  'Ouratite':'#ffeaa7','Riccite':'#ff7675','Savrilium':'#ff4466','Stileron':'#e84393',
  'Beryl':'#00e5a0','Silicon':'#b2bec3','Quartz':'#dfe6e9','Ice':'#81ecec',
  'Aslarite':'#74b9ff','Torite':'#ff8c00','Tin':'#b2bec3','Mg Script':'#a29bfe',
    ...
    <div style={{position:'fixed',inset:0,background:'rgba(0,0,0,0.8)',display:'flex',alignItems:'center',justifyContent:'center',zIndex:1000,padding:16}}>
      <div style={{background:'var(--bg-card)',border:'1px solid rgba(255,200,0,0.4)',borderRadius:12,padding:22,width:'100%',maxWidth:480,boxShadow:'0 20px 60px rgba(0,0,0,0.7)'}}>
        <div style={{display:'flex',alignItems:'center',gap:9,marginBottom:6}}>
          ...
          <span style={{fontFamily:'Orbitron,monospace',fontSize:12,fontWeight:700,color:'var(--accent-gold)',letterSpacing:'0.06em'}}>MINÉRIO DUPLICADO DETECTADO</span>
        </div>
        ...
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:10,marginBottom:12}}>
          <div style={{padding:'10px',background:'rgba(0,229,160,0.06)',border:'1px solid rgba(0,229,160,0.2)',borderRadius:7}}>
          ...
          <div style={{padding:'10px',background:'rgba(0,212,255,0.06)',border:'1px solid rgba(0,212,255,0.2)',borderRadius:7}}>
        ...
        <div style={{display:'flex',gap:8,justifyContent:'flex-end'}}>
          <button onClick={onCancel} style={{padding:'7px 14px',background:'transparent',border:'1px solid var(--border-subtle)',borderRadius:6,color:'var(--text-secondary)',fontFamily:'Rajdhani,sans-serif',fontSize:11,fontWeight:700,cursor:'pointer',textTransform:'uppercase'}}>Cancelar</button>
          <button onClick={onNew} style={{padding:'7px 14px',background:'rgba(0,212,255,0.1)',border:'1px solid rgba(0,212,255,0.3)',borderRadius:6,color:'var(--accent-primary)',fontFamily:'Rajdhani,sans-serif',fontSize:11,fontWeight:700,cursor:'pointer',textTransform:'uppercase'}}>Novo Separado</button>
          <button onClick={onMerge} style={{display:'flex',alignItems:'center',gap:5,padding:'7px 14px',background:'rgba(0,229,160,0.1)',border:'1px solid rgba(0,229,160,0.3)',borderRadius:6,color:'var(--accent-green)',fontFamily:'Rajdhani,sans-serif',fontSize:11,fontWeight:700,cursor:'pointer',textTransform:'uppercase'}}>
            <Plus size={11}/> Somar
          </button>
        </div>
      </div>
  ...
  return (
    <div style={{background:'var(--bg-card)',border:'1px solid var(--border-normal)',borderRadius:10,padding:18,marginBottom:14}}>
      ...
      <div style={{display:'grid',gridTemplateColumns:'1fr 1fr auto',gap:9,marginBottom:9,alignItems:'end'}}>
            ...
            {showQP && (
              <div style={{position:'absolute',top:'100%',left:0,right:0,background:'var(--bg-card)',border:'1px solid var(--border-normal)',borderRadius:6,zIndex:50,overflow:'hidden',boxShadow:'0 8px 20px rgba(0,0,0,0.4)'}}>
                {QUALITY_PRESETS.map(q=>(
                  <button key={q} onMouseDown={()=>set('quality',q)} style={{display:'block',width:'100%',textAlign:'left',padding:'6px 12px',background:'none',border:'none',borderBottom:'1px solid var(--border-subtle)',color:'var(--text-secondary)',cursor:'pointer',fontSize:12,fontFamily:'Rajdhani,sans-serif'}}>{q}</button>
                ))}
              </div>
            )}
          </div>
        ...
        <button onClick={()=>set('refined',!d.refined)} style={{display:'flex',alignItems:'center',gap:7,padding:'8px 12px',background:d.refined?'rgba(0,229,160,0.1)':'transparent',border:`1px solid ${d.refined?'rgba(0,229,160,0.4)':'var(--border-subtle)'}`,borderRadius:5,color:d.refined?'var(--accent-green)':'var(--text-muted)',cursor:'pointer',fontFamily:'Rajdhani,sans-serif',fontSize:12,fontWeight:700,textTransform:'uppercase',whiteSpace:'nowrap',marginBottom:2}}>
...
function OreCard({ entry, onEdit, onDelete, onAdjustQty }) {
  ...
  return (
    <div style={{background:'var(--bg-card)',border:`1px solid ${color}33`,borderLeft:`3px solid ${color}`,borderRadius:8,padding:'11px 13px',overflow:'hidden'}}>
      <div style={{display:'flex',alignItems:'center',gap:10}}>
        ...
        <div style={{flex:1,minWidth:0}}>
          <div style={{display:'flex',alignItems:'center',gap:6,flexWrap:'wrap',marginBottom:2}}>
            <span style={{fontFamily:'Rajdhani,sans-serif',fontSize:13,fontWeight:700,color}}>{entry.ore_name}</span>
            {entry.refined && <span style={{fontSize:9,padding:'1px 5px',borderRadius:3,background:'rgba(0,229,160,0.1)',color:'var(--accent-green)',border:'1px solid rgba(0,229,160,0.25)',fontWeight:700}}>REFINADO</span>}
        ...
        <div style={{textAlign:'right',flexShrink:0}}>
          <div style={{fontFamily:'Orbitron,monospace',fontSize:18,fontWeight:800,color,lineHeight:1}}>{ptNum(entry.quantity)}</div>
        ...
        <div style={{display:'flex',gap:4,flexShrink:0}}>
          ...
          <button onClick={()=>{setAdjMode(!adjMode);setAdjVal('');}} title="Ajustar quantidade"
            style={{width:26,height:26,borderRadius:4,border:`1px solid ${adjMode?'rgba(0,212,255,0.4)':'var(--border-normal)'}`,background:adjMode?'rgba(0,212,255,0.1)':'rgba(255,255,255,0.03)',color:adjMode?'var(--accent-primary)':'var(--text-muted)',cursor:'pointer',display:'flex',alignItems:'center',justifyContent:'center',fontSize:14,fontWeight:700}}>
            ±
          </button>
          <button onClick={()=>onEdit(entry)} style={{width:26,height:26,borderRadius:4,border:'1px solid var(--border-normal)',background:'rgba(0,212,255,0.06)',color:'var(--accent-primary)',cursor:'pointer',display:'flex',alignItems:'center',justifyContent:'center'}}>
            <Edit3 size={11}/>
          </button>
          {delConf ? (
            <div style={{display:'flex',gap:3,alignItems:'center'}}>
              <button onClick={()=>onDelete(entry.id)} style={{padding:'2px 6px',background:'rgba(255,68,102,0.15)',border:'1px solid rgba(255,68,102,0.4)',borderRadius:3,color:'var(--accent-red)',cursor:'pointer',fontSize:10,fontWeight:700}}>Sim</button>
      ...
      {adjMode && (
        <div style={{marginTop:8,padding:'8px 10px',background:'rgba(0,212,255,0.05)',border:'1px solid rgba(0,212,255,0.2)',borderRadius:6,display:'flex',alignItems:'center',gap:8,flexWrap:'wrap'}}>
          {/* Toggle add/sub */}
          <div style={{display:'flex',borderRadius:5,overflow:'hidden',border:'1px solid var(--border-subtle)'}}>
            <button onClick={()=>setAdjType('add')} style={{padding:'4px 10px',background:adjType==='add'?'rgba(0,229,160,0.15)':'transparent',border:'none',borderRight:'1px solid var(--border-subtle)',color:adjType==='add'?'var(--accent-green)':'var(--text-muted)',cursor:'pointer',fontSize:11,fontWeight:700,fontFamily:'Rajdhani,sans-serif',textTransform:'uppercase'}}>
              + Adicionar
            </button>
            <button onClick={()=>setAdjType('sub')} style={{padding:'4px 10px',background:adjType==='sub'?'rgba(255,68,102,0.12)':'transparent',border:'none',color:adjType==='sub'?'var(--accent-red)':'var(--text-muted)',cursor:'pointer',fontSize:11,fontWeight:700,fontFamily:'Rajdhani,sans-serif',textTransform:'uppercase'}}>
              − Remover
            </button>
          </div>
          {/* Atalhos rápidos */}
          {[1,5,10,25,50].map(n=>(
            <button key={n} onClick={()=>onAdjustQty(entry.id, adjType==='add'?entry.quantity+n:Math.max(0,entry.quantity-n))}
              style={{padding:'3px 8px',background:adjType==='add'?'rgba(0,229,160,0.08)':'rgba(255,68,102,0.08)',border:`1px solid ${adjType==='add'?'rgba(0,229,160,0.2)':'rgba(255,68,102,0.2)'}`,borderRadius:4,color:adjType==='add'?'var(--accent-green)':'var(--accent-red)',cursor:'pointer',fontSize:11,fontFamily:'Share Tech Mono,monospace'}}>
              {adjType==='add'?'+':'-'}{n}
            </button>
          ))}
          {/* Input manual */}
          ...
          <button onClick={applyAdj} style={{display:'flex',alignItems:'center',gap:4,padding:'4px 10px',background:adjType==='add'?'rgba(0,229,160,0.1)':'rgba(255,68,102,0.1)',border:`1px solid ${adjType==='add'?'rgba(0,229,160,0.3)':'rgba(255,68,102,0.3)'}`,borderRadius:4,color:adjType==='add'?'var(--accent-green)':'var(--accent-red)',cursor:'pointer',fontSize:11,fontWeight:700,fontFamily:'Rajdhani,sans-serif',textTransform:'uppercase'}}>
    ...
    <div style={{display:'flex',flexDirection:'column',height:'100%',overflow:'hidden'}}>
      ...
      <div style={{flex:1,display:'grid',gridTemplateColumns:'240px 1fr',overflow:'hidden'}}>
        ...
        <div style={{borderRight:'1px solid var(--border-subtle)',overflowY:'auto',padding:12}}>
            ...
            summary.map(s=>{
              ...
              return (
                <button key={s.name} onClick={()=>{
                  ...
                  <div style={{textAlign:'right',flexShrink:0}}>
                    <div style={{fontFamily:'Orbitron,monospace',fontSize:12,fontWeight:800,color}}>{ptNum(s.total)}</div>
          ...
          {totalEntries>0 && (
            <div style={{marginTop:12,padding:'9px 11px',background:'rgba(0,119,255,0.05)',border:'1px solid rgba(0,119,255,0.12)',borderRadius:7}}>
        ...
        <div style={{overflowY:'auto',padding:'12px 16px'}}>
          ...
          <div style={{display:'flex',alignItems:'center',gap:6,marginBottom:14,flexWrap:'wrap'}}>
            <button onClick={()=>{setSelCategory(null);setSelOre(null);setSearch('');}} style={{background:'none',border:'none',cursor:'pointer',color:selCategory?'var(--accent-primary)':'var(--text-primary)',fontFamily:'Orbitron,monospace',fontSize:11,fontWeight:700,padding:0}}>
              🗃 Todos os Grupos
            </button>
            {selCategory && (
              <>
                <span style={{color:'var(--text-muted)'}}>›</span>
                <button onClick={()=>{setSelOre(null);setSearch('');}} style={{background:'none',border:'none',cursor:selOre?'pointer':'default',color:selOre?'var(--accent-primary)':'var(--text-primary)',fontFamily:'Rajdhani,sans-serif',fontSize:12,fontWeight:700,padding:0,display:'flex',alignItems:'center',gap:4}}>
            ...
            {selOre && (
              <>
                <span style={{color:'var(--text-muted)'}}>›</span>
                <span style={{fontFamily:'Rajdhani,sans-serif',fontSize:12,fontWeight:700,color:getOreColor(selOre)}}>{selOre}</span>
              </>
            )}
          ...
          {!selCategory && !search.trim() && (
            <div>
              <div style={{fontFamily:'Orbitron,monospace',fontSize:11,fontWeight:700,color:'var(--text-muted)',textTransform:'uppercase',letterSpacing:'0.1em',marginBottom:12}}>
              ...
              <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fill,minmax(200px,1fr))',gap:10,marginBottom:20}}>
                {CATEGORIES.map(cat=>{
                  ...
                  return (
                    ...
                    onMouseLeave={e=>{e.currentTarget.style.transform='';e.currentTarget.style.boxShadow='';}}>
                      ...
                      <div style={{fontFamily:'Orbitron,monospace',fontSize:12,fontWeight:800,color:data.color,marginBottom:4,letterSpacing:'0.04em'}}>{cat}</div>
                ...
                onMouseEnter={e=>{e.currentTarget.style.borderColor='var(--accent-primary)';e.currentTarget.style.background='rgba(0,212,255,0.04)';}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='var(--border-normal)';e.currentTarget.style.background='rgba(255,255,255,0.02)';}}>
                  ...
                  <div style={{fontFamily:'Orbitron,monospace',fontSize:11,fontWeight:700,color:'var(--text-muted)',marginBottom:4}}>VER TUDO</div>
          ...
          {selCategory && selCategory!=='__all' && !selOre && !search.trim() && (
            <div>
              <div style={{fontFamily:'Orbitron,monospace',fontSize:11,fontWeight:700,color:ORE_DATABASE[selCategory]?.color,textTransform:'uppercase',letterSpacing:'0.1em',marginBottom:12}}>
                  ...
                  return (
                    ...
                    onMouseLeave={e=>{e.currentTarget.style.opacity=hasEntries?'1':'0.45';e.currentTarget.style.borderColor=hasEntries?color+'44':'var(--border-subtle)';}}>
                      <div style={{display:'flex',alignItems:'center',gap:6,marginBottom:4}}>
                        <span style={{fontFamily:'Rajdhani,sans-serif',fontSize:12,fontWeight:700,color:hasEntries?color:'var(--text-muted)',flex:1,overflow:'hidden',textOverflow:'ellipsis',whiteSpace:'nowrap'}}>{name}</span>
                      ...
                      {hasEntries ? (
                        <div>
                          <div style={{fontFamily:'Orbitron,monospace',fontSize:14,fontWeight:800,color,lineHeight:1}}>{ptNum(total)}</div>
            ...
            <div>
              ...
              {entries.length===0 ? (
                <div style={{textAlign:'center',padding:'40px 0',color:'var(--text-muted)'}}>
                  ...
                  <div style={{fontFamily:'Orbitron,monospace',fontSize:12,fontWeight:700,marginBottom:6}}>SEM ENTRADAS</div>
